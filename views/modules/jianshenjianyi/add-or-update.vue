		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.tupian" label="图片" prop="tupian">
					<img v-if="ruleForm.tupian.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" :key="'http-' + index" :src="ruleForm.tupian.split(',')[0]" width="100" height="100">
<img v-else class="upload-img" style="margin-right:20px;" v-for="(item, index) in ruleForm.tupian.split(',')" :key="'local-' + index" :src="$base.url+item" width="100" height="100">
				</el-form-item>
